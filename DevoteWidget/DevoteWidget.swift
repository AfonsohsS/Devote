...
//  DevoteWidget
//
//  Created by Afonso Sabino on 23/07/21.
//
...
struct DevoteWidgetEntryView : View {
    ...
    // Para identificar a familia do Widget (small, medium, large)
    @Environment(\.widgetFamily) var widgetFamily
    
    // Ajusta a font do "Just Do It"conforme tamanho do widget
    var fontStyle: Font {
...
struct DevoteWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .description("An example widget for the personal task manager app.")
    }
}
